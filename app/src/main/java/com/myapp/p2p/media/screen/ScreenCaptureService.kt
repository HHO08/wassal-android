package com.myapp.p2p.media.screen
...
class ScreenCaptureService : Service() {
    ...
    private fun createGalleryFile(): File {
        ...
        val file = File(dir, "MyApp_$stamp.mp4")
        // Register with MediaStore so it appears in the gallery immediately.
        val values = ContentValues().apply {
            put(MediaStore.Video.Media.DISPLAY_NAME, "MyApp_$stamp.mp4")
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("MyApp is capturing your screen")
